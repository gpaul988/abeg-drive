...
export default function AdminReportsPage() {
  ...
  return (
    <AppShell navLinks={getAdminNavLinks(role)} activeHref="/admin/reports" roleLabel="Admin">
      <h1 className="text-xl font-semibold text-neutral-900 mb-2">Compliance report</h1>
      ...
      {report && (
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          <Card>
            ...
            <p className="text-2xl font-semibold text-neutral-900">{report.totalDrivers}</p>
          </Card>
          <Card>
            <p className="text-sm text-neutral-500 mb-1">Approved drivers</p>
            <p className="text-2xl font-semibold text-neutral-900">{report.approvedDrivers}</p>
          </Card>
          <Card>
            <p className="text-sm text-neutral-500 mb-1">Drivers in probation</p>
            <p className="text-2xl font-semibold text-neutral-900">{report.driversInProbation}</p>
          </Card>
          <Card>
          ...
          <Card>
            <p className="text-sm text-neutral-500 mb-1">Total incidents</p>
            <p className="text-2xl font-semibold text-neutral-900">{report.totalIncidents}</p>
          </Card>
          <Card>
            <p className="text-sm text-neutral-500 mb-1">Incidents resolved</p>
            <p className="text-2xl font-semibold text-neutral-900">{report.incidentsResolved}</p>
          </Card>
          <Card>
            <p className="text-sm text-neutral-500 mb-1">Escalated to security partner</p>
            <p className="text-2xl font-semibold text-neutral-900">{report.incidentsEscalatedToSecurityPartner}</p>
          </Card>
          <Card className="sm:col-span-2 lg:col-span-3">
            <p className="text-sm text-neutral-500 mb-2">Incidents by type</p>
