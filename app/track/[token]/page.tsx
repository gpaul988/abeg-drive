  ...
  return (
    <div className="min-h-screen bg-neutral-50 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        {!data && <p className="text-center text-neutral-400 text-sm">Loading…</p>}

        {data?.error && (
          <Card>
            <p className="text-sm text-neutral-500 text-center">This tracking link is invalid or has expired.</p>
          </Card>
        )}
        ...
        {data && !data.error && (
          <Card>
            <div className="flex items-center justify-between mb-4">
              <h1 className="font-semibold text-neutral-900">Shared trip</h1>
            ...
            <div className="aspect-video bg-neutral-100 rounded-xl border border-dashed border-neutral-300 flex items-center justify-center mb-4">
              <span className="text-neutral-400 text-sm">Live map</span>
            </div>
            ...
            {data.driver && (
              <div className="flex items-center justify-between border-t border-neutral-200 pt-4 text-sm">
                <span className="text-neutral-900 capitalize">Driver: {data.driver.firstName}</span>
                <span className="text-neutral-600">ETA {data.driver.etaMinutes} min</span>
              </div>
            )}
          </Card>
        )}
